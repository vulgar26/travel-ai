...
/**
 * Financial analysis aliases for the existing user knowledge library.
 */
@RestController
@RequestMapping({"/analysis/knowledge", "/finance/knowledge"})
public class AnalysisKnowledgeController {

    private final KnowledgeService knowledgeService;

    public AnalysisKnowledgeController(KnowledgeService knowledgeService) {
